...
COMMENT ON COLUMN public.student.created_at IS 'Дата создания. Не изменяется после создания';
COMMENT ON COLUMN public.student.updated_at IS 'Дата последнего изменения. Если не было изменений то null';
