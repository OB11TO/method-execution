package ru.ob11to.methodexecution.aop;
...
import ru.ob11to.methodexecution.service.ExecutionTimeMethodService;
...
public class TimeTrackingAspect {
    ...
    @Pointcut("@annotation(ru.ob11to.methodexecution.annotation.TrackTime)")
    public void hasTrackTime() {
    }

    @Pointcut("@annotation(ru.ob11to.methodexecution.annotation.TrackAsyncTime)")
